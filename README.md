...
Consideration about protocol
=============================

**Fixed size vs EOL terminated digit strings**

Lets assume we are expecting number from a range 0-0xFFFF
>   +-------------------------+----------------------+-------------------------------+------------+
>   | **test case**           | **Fixed size**       | **EOL terminated**            | **EOL alt**|
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM\n                   | Fail  (alt: 0 )      | Fail   (alt: 0 )              |   0        |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM0\n                  | Fail  (alt: 0 )      | 0                             |            |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM003\n                | Fail  (alt: 3 )      | 3                             |            |
...
>   | CTM1234\n               | 0x1234               | 0x1234                        |            |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM12XXX\n              | Fail,incorrect format| Fail,incorrect format   ?     |  0x12      |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM1234XXX              | 0x1234               | Fail,incorrect format   ?     |  0x1234    |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM12345\n              | 0x1234               | Fail,out of range             |  ?         |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM00000123\n           | 0                    | 123                     ?     |            |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM012345\n             | 0x123                | Fail, out of range      ?     |  ?         |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM01234XXX\n           | 0x123                | Fail, incorrect format  ?     | 0x1234     |
>   +-------------------------+----------------------+-------------------------------+------------+
>   | CTM012345XX\n           | 0x123                | Fail, incorrect format ? /oor?| oor?       |
>   +-------------------------+----------------------+-------------------------------+------------+
